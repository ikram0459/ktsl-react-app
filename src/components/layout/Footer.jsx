...
const socialLinks = [
  { label: "Facebook", url: "https://www.facebook.com/ikram.niazi", icon: (
    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
  )},
  { label: "LinkedIn", url: "https://www.linkedin.com/in/ikram0459", icon: (
    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452H17.2v-5.569c0-1.328-.027-3.036-1.85-3.036-1.852 0-2.135 1.444-2.135 2.936v5.669H9.007V9h3.084v1.561h.045c.43-.815 1.48-1.673 3.048-1.673 3.26 0 3.865 2.146 3.865 4.936v6.628zM5.337 7.433a1.79 1.79 0 1 1 0-3.58 1.79 1.79 0 0 1 0 3.58zM6.72 20.452H3.952V9h2.768v11.452zM22.225 0H1.771C.792 0 0 .77 0 1.72v20.56C0 23.23.792 24 1.771 24h20.451C23.2 24 24 23.23 24 22.28V1.72C24 .77 23.2 0 22.225 0z"/></svg>
  )},
  { label: "Instagram", url: "https://www.instagram.com/ikr.nz0459", icon: (
  ...
  { label: "YouTube", url: "https://www.youtube.com/@ikram0459", icon: (
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <Link to="/portfolio" className="block text-muted-foreground text-sm hover:text-primary transition-colors">Portfolio</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <Link to="/cookies" className="block text-muted-foreground text-sm hover:text-primary transition-colors">Cookies Policy</Link>
        ...
        <div className="border-t border-border/50 pt-8">
          <p className="text-center text-muted-foreground text-xs font-mono tracking-wider">
            <a target="_blank" href="https://linktr.ee/ikram0459" className="hover:text-primary transition-colors">
              Khan Tech Services
